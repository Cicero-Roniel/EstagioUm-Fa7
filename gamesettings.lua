...
function scene:create( event )
    ...
    local title = display.newText("Configurações", 100, 32, native.systemFontBold, 100 )
    title.x = display.contentCenterX 
    title.y = 40
    title:setFillColor( 0 )
    sceneGroup:insert( title )

    local soundLabel = display.newText("Sound Effects", 100, 100, native.systemFont, 70 )
    ...
    soundOnOffSwitch.x = display.contentCenterX + 200
    soundOnOffSwitch.y = soundLabel.y
    sceneGroup:insert( soundOnOffSwitch )

    local musicLabel = display.newText("Music", 100, 100, native.systemFont, 70 )
    ...
    musicOnOffSwitch.x = display.contentCenterX + 200
